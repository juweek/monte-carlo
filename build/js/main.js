...
------------------------------
*/
var euclideanDistance = function euclideanDistance(x1, x2, y1, y2) {
...
------------------------------
*/
var canvas = d3.select('#canvas-element').attr('width', circleWidth).attr('height', circleHeight);
...
------------------------------
*/
var drawPoint = function drawPoint(x, y, r) {
  context.beginPath();
...
------------------------------
*/
restartButton.addEventListener('click', function (o) {
  if (validateText()) {
    totalPointsDrawn = 0;
    totalInCircle = 0;
    drawCircle();
...
startButton.addEventListener('click', function (o) {
  if (validateText()) {
